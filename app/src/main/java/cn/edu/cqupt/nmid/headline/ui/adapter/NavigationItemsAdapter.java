...
public class NavigationItemsAdapter extends ArrayAdapter<NavigationItemsAdapter.NavItem> {
    ...
    public NavigationItemsAdapter(Context context) {
        ...
        mDataset.add(new NavItem(R.drawable.ic_home_grey600_24dp, R.string.action_settings));
        mDataset.add(new NavItem(R.drawable.ic_radical_black_24dp, R.string.action_settings));
        mDataset.add(new NavItem(R.drawable.ic_kanji_black_24dp, R.string.action_settings));
        mDataset.add(new NavItem(R.drawable.ic_vocabulary_black_24dp, R.string.action_settings));
    }
