...
import cn.edu.cqupt.nmid.headline.ui.activity.util.SystemUiHider;
...
public class PhotoViewActivity extends Activity {
  ...
  @InjectView(R.id.iv_photo_view) PhotoView mIvPhotoView;
  @InjectView(R.id.dummy_button) Button mDummyButton;
  @InjectView(R.id.fullscreen_content_controls) LinearLayout mFullscreenContentControls;
  ...
  private String image_previous;
  public static final String IMAGE_SIEZ_FULL = "full_size";
  public static final String IMAGE_SIEZ_PREVIOUS = "previous_size";
    ...
    mSystemUiHider.setOnVisibilityChangeListener(new SystemUiHider.OnVisibilityChangeListener() {
      ...
      public void onVisibilityChange(boolean visible) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB_MR2) {
          ...
          mFullscreenContentControls.animate()
