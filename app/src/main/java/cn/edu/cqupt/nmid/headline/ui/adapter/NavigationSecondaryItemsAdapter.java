 ...
 */
public class NavigationSecondaryItemsAdapter
    extends ArrayAdapter<NavigationSecondaryItemsAdapter.NavSecondaryItem> {
  ...
  public NavigationSecondaryItemsAdapter(Context context) {
    ...
    mDataset.add(new NavSecondaryItem(R.drawable.ic_settings_black_24dp, R.string.action_settings));
    mDataset.add(new NavSecondaryItem(R.drawable.ic_logout_black_24dp, R.string.action_exit));
  }
