...
package cn.edu.cqupt.nmid.headline.ui.widget.observerWebView;
...
public class ObservableWebView extends WebView implements Scrollable {
    ...
    protected void onScrollChanged(int l, int t, int oldl, int oldt) {
        ...
        if (mCallbacks != null) {
            ...
            mCallbacks.onScrollChanged(t - oldt, mFirstScroll, mDragging);
            if (mFirstScroll) {
                mFirstScroll = false;
            }
        ...
        if (mCallbacks != null) {
            switch (ev.getActionMasked()) {
                ...
                case MotionEvent.ACTION_CANCEL:
                    mIntercepted = false;
                    mDragging = false;
                    //Solved Long pressed will cause a NullPointerException
